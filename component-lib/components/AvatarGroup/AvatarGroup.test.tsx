...
describe('AvatarGroup', () => {
  ...
  describe('Avatar Interactions', () => {
    it('calls onAvatarClick when avatar is clicked', async () => {
      ...
      expect(mockOnAvatarClick).toHaveBeenCalledWith(mockAvatars[0], 0);
    });
    ...
    it('adds proper accessibility attributes for clickable avatars', () => {
      ...
      expect(avatarButtons[0]).toHaveAttribute('aria-label', 'View User 1 profile');
      expect(avatarButtons[1]).toHaveAttribute('aria-label', 'View User 2 profile');
