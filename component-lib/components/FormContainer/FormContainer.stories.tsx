...
export const FeedbackForm: Story = {
  args: {
    ...
    onSubmit: action('feedback-submitted'),
  },
};
...
export const MultiStepForm: Story = {
  args: {
    ...
    submitText: 'Continue',
    showReset: false,
    onSubmit: action('step-completed'),
  },
};
...
export const DarkMode: Story = {
  args: {
    ...
    submitText: 'Sign Up',
    showReset: true,
    onSubmit: action('dark-form-submitted'),
  },
  parameters: {
...
export const ComprehensiveSurvey: Story = {
  args: {
    ...
    showReset: true,
    resetText: 'Clear All',
    onSubmit: action('survey-submitted'),
    onFieldChange: action('survey-field-changed'),
  },
};
...
export const Playground: Story = {
  args: {
    ...
    onSubmit: action('playground-submitted'),
    onFieldChange: action('playground-field-changed'),
  },
};