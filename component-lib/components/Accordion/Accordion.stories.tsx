    ...
    content: (
      <div>
        ...
        <ul style={{ paddingLeft: '20px', margin: '12px 0' }}>
          <li><strong>Base:</strong> Button, Input, Icon, Text, Badge, Avatar</li>
          <li><strong>Forms:</strong> Checkbox, Radio, Select, Switch, Textarea</li>
          <li><strong>Complex:</strong> Modal, Accordion, Pagination, Tabs, Dropdown</li>
        </ul>
        <p style={{ color: '#666', fontSize: '14px' }}>
          All components are designed for maximum reusability and composability.
        </p>
      </div>
    ),
